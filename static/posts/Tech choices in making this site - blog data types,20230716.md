---
title: Tech choices in making this site - blog data types
...
* Markdown and YAML - seems like the solution! Can split the item, and markdown is an easy format to write in, plus th  
